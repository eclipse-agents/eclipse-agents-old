 ...
 *******************************************************************************/
package org.eclipse.agents.clients.chat;

import java.util.ArrayList;
import java.util.List;

import org.eclipse.agents.clients.AcpService;
import org.eclipse.agents.clients.IAcpSessionListener;
import org.eclipse.agents.clients.agent.IAgentService;
import org.eclipse.agents.clients.protocol.AcpSchema.CancelNotification;
import org.eclipse.agents.clients.protocol.AcpSchema.CreateTerminalRequest;
import org.eclipse.agents.clients.protocol.AcpSchema.CreateTerminalResponse;
import org.eclipse.agents.clients.protocol.AcpSchema.KillTerminalCommandRequest;
import org.eclipse.agents.clients.protocol.AcpSchema.KillTerminalCommandResponse;
import org.eclipse.agents.clients.protocol.AcpSchema.McpServer;
import org.eclipse.agents.clients.protocol.AcpSchema.PlanEntry;
import org.eclipse.agents.clients.protocol.AcpSchema.PlanEntryStatus;
import org.eclipse.agents.clients.protocol.AcpSchema.PromptRequest;
import org.eclipse.agents.clients.protocol.AcpSchema.PromptResponse;
import org.eclipse.agents.clients.protocol.AcpSchema.ReadTextFileRequest;
import org.eclipse.agents.clients.protocol.AcpSchema.ReadTextFileResponse;
import org.eclipse.agents.clients.protocol.AcpSchema.ReleaseTerminalRequest;
import org.eclipse.agents.clients.protocol.AcpSchema.ReleaseTerminalResponse;
import org.eclipse.agents.clients.protocol.AcpSchema.RequestPermissionRequest;
import org.eclipse.agents.clients.protocol.AcpSchema.RequestPermissionResponse;
import org.eclipse.agents.clients.protocol.AcpSchema.SessionAgentMessageChunk;
import org.eclipse.agents.clients.protocol.AcpSchema.SessionAgentThoughtChunk;
import org.eclipse.agents.clients.protocol.AcpSchema.SessionAvailableCommandsUpdate;
import org.eclipse.agents.clients.protocol.AcpSchema.SessionModeState;
import org.eclipse.agents.clients.protocol.AcpSchema.SessionModeUpdate;
import org.eclipse.agents.clients.protocol.AcpSchema.SessionNotification;
import org.eclipse.agents.clients.protocol.AcpSchema.SessionPlan;
import org.eclipse.agents.clients.protocol.AcpSchema.SessionToolCall;
import org.eclipse.agents.clients.protocol.AcpSchema.SessionToolCallUpdate;
import org.eclipse.agents.clients.protocol.AcpSchema.SessionUserMessageChunk;
import org.eclipse.agents.clients.protocol.AcpSchema.SetSessionModeRequest;
import org.eclipse.agents.clients.protocol.AcpSchema.SetSessionModeResponse;
import org.eclipse.agents.clients.protocol.AcpSchema.TerminalOutputRequest;
import org.eclipse.agents.clients.protocol.AcpSchema.TerminalOutputResponse;
import org.eclipse.agents.clients.protocol.AcpSchema.TextBlock;
import org.eclipse.agents.clients.protocol.AcpSchema.WaitForTerminalExitRequest;
import org.eclipse.agents.clients.protocol.AcpSchema.WaitForTerminalExitResponse;
import org.eclipse.agents.clients.protocol.AcpSchema.WriteTextFileRequest;
import org.eclipse.agents.clients.protocol.AcpSchema.WriteTextFileResponse;
import org.eclipse.agents.contexts.Tracer;
