...
async function updateElements() {
    ...
    addMessage("thought1", "agent_thought_chunk", thought1);
    await sleep(1000);

    addMessage("thought2", "agent_thought_chunk", thought2);
    await sleep(1000);

    addMessage("thought3", "agent_thought_chunk", thought3);
    await sleep(1000);

    addMessage("thought4", "agent_thought_chunk", thought4);
    await sleep(1000);

    addMessage("thought5", "agent_thought_chunk", thought5);
    await sleep(1000);
    
    addMessage("agent-message1", "agent_message_chunk", agentMessage1);
    await sleep(1000);
    
   updateMessage("agent-message1",  agentMessage1 +
        agentMessage2);
    await sleep(1000);
