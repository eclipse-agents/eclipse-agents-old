...
public interface IPreferenceConstants {
	...
	public static final String P_ACP_NODE = Activator.PLUGIN_ID + ".acp.node"; //$NON-NLS-1$

	public static final String P_ACP_GEMINI = Activator.PLUGIN_ID + ".acp.gemini"; //$NON-NLS-1$
